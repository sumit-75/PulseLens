  ...
  return (
    <div className="min-h-screen w-full bg-[#0e0d08] text-[#e2e7e3] selection:bg-[#e2e7e3]/20 selection:text-[#e2e7e3] font-sans overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0">
        <div className="absolute top-[-10%] left-[10%] sm:left-[20%] w-[350px] sm:w-[600px] h-[350px] sm:h-[600px] rounded-full bg-[#e2e7e3]/[0.025] blur-[100px] sm:blur-[140px]" />
        <div className="absolute top-[40%] right-[5%] sm:right-[10%] w-[300px] sm:w-[500px] h-[300px] sm:h-[500px] rounded-full bg-[#e2e7e3]/[0.02] blur-[120px] sm:blur-[160px]" />
      </div>

      {/* Sticky Header / Navbar */}
      <header className="sticky top-0 z-50 w-full border-b border-[#e2e7e3]/10 bg-[#0e0d08]/90 backdrop-blur-xl transition-all">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
          {/* Brand Logo */}
          <Link href="/" className="flex items-center gap-3 group">
            <div className="h-9 w-9 sm:h-10 sm:w-10 rounded-xl bg-gradient-to-br from-[#e2e7e3] to-[#889089] flex items-center justify-center shadow-lg shadow-[#e2e7e3]/10 text-[#0e0d08] transition-transform group-hover:scale-105 shrink-0">
          ...
          <div className="flex sm:hidden items-center gap-2">
            <Link href="/dashboard">
              <Button size="sm" className="h-8 px-3 text-xs font-bold">
                Dashboard
              </Button>
            </Link>
            ...
            <button
              ...
              className="p-2 rounded-lg bg-[#15140e] border border-[#e2e7e3]/15 text-[#e2e7e3]"
        ...
        {isMobileMenuOpen && (
          <div className="sm:hidden border-t border-[#e2e7e3]/10 bg-[#12110b]/98 px-5 py-6 space-y-4 shadow-2xl animate-in slide-in-from-top-2 duration-200">
            <div className="flex flex-col space-y-3 text-sm font-medium text-[#a6aea7]">
              <a
                href="#features"
                onClick={() => setIsMobileMenuOpen(false)}
                className="py-2 hover:text-[#e2e7e3] transition-colors border-b border-[#e2e7e3]/5"
              >
                Features
              </a>
              <a
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="py-2 hover:text-[#e2e7e3] transition-colors flex items-center justify-between border-b border-[#e2e7e3]/5"
              >
      ...
      {/* Hero Section */}
      <section className="relative z-10 pt-12 sm:pt-20 lg:pt-24 pb-16 sm:pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        <ScrollReveal direction="up" delayMs={50}>
          {/* Top Feature Pill */}
          <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 rounded-full bg-[#181711] border border-[#e2e7e3]/15 text-xs sm:text-sm text-[#e2e7e3] mb-6 shadow-sm">
            <Sparkles className="h-4 w-4 text-[#e2e7e3] shrink-0" />
            <span className="font-medium text-[#a6aea7] text-left sm:text-center">
              Full-Stack Telemetry & Distributed Monitoring Platform
            </span>
          </div>

          {/* Hero Title */}
          <h1 className="text-3xl sm:text-5xl lg:text-7xl font-bold tracking-tight text-[#e2e7e3] max-w-5xl mx-auto leading-[1.15] sm:leading-[1.1]">
            Unified Telemetry for Modern Cloud & Microservices
          </h1>

          {/* Hero Subtitle */}
          <p className="mt-5 sm:mt-6 text-sm sm:text-lg lg:text-xl text-[#a6aea7] max-w-3xl mx-auto font-normal leading-relaxed">
        ...
        <ScrollReveal direction="up" delayMs={150}>
          <div className="mt-12 sm:mt-16 relative mx-auto max-w-5xl rounded-2xl sm:rounded-3xl border border-[#e2e7e3]/15 bg-[#12110b]/95 p-3 sm:p-5 shadow-2xl backdrop-blur-2xl text-left">
            {/* Top Window Bar */}
            <div className="flex items-center justify-between pb-3.5 mb-3 border-b border-[#e2e7e3]/10 px-1 sm:px-2">
              <div className="flex items-center gap-2">
                <span className="h-3 w-3 rounded-full bg-rose-500/80 inline-block" />
                <span className="h-3 w-3 rounded-full bg-amber-500/80 inline-block" />
                <span className="h-3 w-3 rounded-full bg-emerald-500/80 inline-block" />
                <span className="ml-2 text-xs font-mono text-[#889089] truncate">
              ...
              <div className="flex items-center gap-2 text-xs font-mono text-emerald-400 shrink-0">
                <LiveDot size="sm" />
                <span className="hidden sm:inline">3s Live Ingestion</span>
                <span className="sm:hidden">Live</span>
              </div>
            </div>

            {/* Terminal Stream Rows */}
            <div className="space-y-2 font-mono text-xs sm:text-[13px] overflow-x-auto p-1 sm:p-2">
              <div className="flex items-center gap-2.5 sm:gap-3 p-2 rounded-lg bg-[#181711]/80 border border-[#e2e7e3]/8 min-w-[500px] sm:min-w-0">
                <span className="px-2 py-0.5 rounded-full text-[11px] font-bold uppercase bg-emerald-500/15 text-emerald-400 border border-emerald-500/25 shrink-0">
                  INFO
                </span>
                <span className="text-[#a6aea7] px-2 py-0.5 rounded bg-[#0e0d08] border border-[#e2e7e3]/10 shrink-0">
                  payment-service
                </span>
                <span className="text-[#e2e7e3] truncate flex-1">
                  Processed webhook payload for order #ORD-9412 in 34ms
                </span>
                <span className="text-[#889089] text-[11px] shrink-0">Just now</span>
              </div>

              <div className="flex items-center gap-2.5 sm:gap-3 p-2 rounded-lg bg-[#181711]/80 border border-[#e2e7e3]/8 min-w-[500px] sm:min-w-0">
                <span className="px-2 py-0.5 rounded-full text-[11px] font-bold uppercase bg-amber-500/15 text-amber-300 border border-amber-500/25 shrink-0">
                  WARN
                </span>
                <span className="text-[#a6aea7] px-2 py-0.5 rounded bg-[#0e0d08] border border-[#e2e7e3]/10 shrink-0">
                  auth-service
                ...
                <span className="text-[#889089] text-[11px] shrink-0">2s ago</span>
              </div>

              <div className="flex items-center gap-2.5 sm:gap-3 p-2 rounded-lg bg-[#181711]/80 border border-[#e2e7e3]/8 min-w-[500px] sm:min-w-0">
                <span className="px-2 py-0.5 rounded-full text-[11px] font-bold uppercase bg-rose-500/15 text-rose-300 border border-rose-500/25 shrink-0">
                  ERROR
                </span>
                <span className="text-[#a6aea7] px-2 py-0.5 rounded bg-[#0e0d08] border border-[#e2e7e3]/10 shrink-0">
                  order-service
                ...
                <span className="text-[#889089] text-[11px] shrink-0">4s ago</span>
              </div>
            </div>
          </div>
        </ScrollReveal>
      ...
      <section className="relative z-10 py-10 sm:py-14 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <ScrollReveal direction="up" delayMs={50}>
      ...
      <section id="features" className="relative z-10 py-16 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto scroll-mt-24">
        <ScrollReveal direction="up" delayMs={50}>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <ScrollReveal direction="up" delayMs={100} className="lg:col-span-7">
              <div className="h-full rounded-3xl border border-[#e2e7e3]/12 bg-[#15140e] p-6 sm:p-8 shadow-2xl flex flex-col justify-between hover:border-[#e2e7e3]/30 transition-all group">
                <div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-6 sm:pt-8 mt-6 border-t border-[#e2e7e3]/10">
                  <div>
            ...
            <ScrollReveal direction="up" delayMs={150} className="lg:col-span-5">
              <div className="h-full rounded-3xl border border-[#e2e7e3]/12 bg-[#15140e] p-6 sm:p-8 shadow-2xl flex flex-col justify-between hover:border-[#e2e7e3]/30 transition-all group">
                <div>
                  {/* Icon */}
      ...
      <section id="sdk" className="relative z-10 py-16 sm:py-20 border-t border-[#e2e7e3]/10 bg-[#12110b]/40 backdrop-blur-md scroll-mt-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            {/* Left Content */}
            <ScrollReveal direction="right" delayMs={100} className="lg:col-span-5 space-y-6">
            ...
            <ScrollReveal direction="left" delayMs={150} className="lg:col-span-7">
              <div className="rounded-3xl border border-[#e2e7e3]/15 bg-[#14130d] overflow-hidden shadow-2xl">
                {/* macOS Style Top Window Bar */}
                <div className="flex items-center justify-between border-b border-[#e2e7e3]/10 bg-[#12110b] px-3 sm:px-4 py-3">
                  <div className="flex items-center gap-2 sm:gap-3 overflow-x-auto no-scrollbar">
                    ...
                    {/* Code Tabs */}
                    <div className="flex items-center gap-1 sm:gap-1.5 sm:pl-2 sm:border-l sm:border-[#e2e7e3]/10">
                      {(['sdk', 'curl', 'traffic'] as const).map((tab) => (
                        <button
                          key={tab}
                          onClick={() => setActiveCodeTab(tab)}
                          className={`px-2.5 sm:px-3 py-1.5 rounded-lg text-xs font-mono font-medium whitespace-nowrap transition-all ${
                            activeCodeTab === tab
                  ...
                  <button
                    ...
                    className="p-1.5 px-2.5 text-[#889089] hover:text-[#e2e7e3] hover:bg-[#1c1a12] rounded-lg transition-colors flex items-center gap-1.5 text-xs font-mono border border-transparent hover:border-[#e2e7e3]/10 shrink-0"
                  >
                    {copied ? (
                      <>
                ...
                <div className="p-4 sm:p-6 text-xs sm:text-[13.5px] font-mono text-[#e2e7e3] overflow-x-auto leading-relaxed bg-[#0e0d08]">
                  {activeCodeTab === 'sdk' && (
      ...
      <section id="architecture" className="relative z-10 py-16 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto scroll-mt-24">
        <ScrollReveal direction="up" delayMs={50}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <ScrollReveal direction="up" delayMs={50}>
            <div className="h-full p-5 sm:p-6 rounded-2xl sm:rounded-3xl border border-[#e2e7e3]/10 bg-[#15140e]/90 text-center relative group hover:border-[#e2e7e3]/25 transition-all shadow-xl">
              ...
              <p className="text-xs text-[#a6aea7] mt-1.5 leading-relaxed">
      ...
      <section className="relative z-10 py-16 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <ScrollReveal direction="up" delayMs={50}>
          <Card className="p-7 sm:p-12 border-[#e2e7e3]/20 bg-gradient-to-b from-[#15140e] to-[#0e0d08] text-center rounded-3xl shadow-2xl relative overflow-hidden">
            <div className="relative z-10 max-w-3xl mx-auto">
              <h2 className="text-2xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-[#e2e7e3]">
                Gain Instant Visibility Into Your Microservices
              </h2>
              <p className="mt-4 text-sm sm:text-base lg:text-lg text-[#a6aea7] font-normal leading-relaxed">
              ...
              <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-3.5">
                <Link href="/dashboard" className="w-full sm:w-auto">
                  <Button size="lg" className="w-full sm:w-auto h-12 px-8 text-sm sm:text-base font-bold gap-2">
                    <span>Open Live Workspace</span>
                    <ArrowRight className="h-4 w-4" />
                  </Button>
                </Link>
                ...
                <Link href="/login" className="w-full sm:w-auto">
                  <Button
                    variant="outline"
                    size="lg"
                    className="w-full sm:w-auto h-12 px-6 text-sm sm:text-base font-semibold border-[#e2e7e3]/20 bg-[#181711] text-[#e2e7e3]"
                  >
